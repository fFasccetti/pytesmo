...
class BasicMetricsQC(object):
    ...
    def calc_metrics(self,data,gpi_info):
        ...
        for season in self.seasons:
            ...
            data_results = EC(data,correlated=[['ref','other3']])
            ...
            dataset['{:}_sig_corr_xy'.format(season)][0] = data_results['sig_corr_ref_other3']
            dataset['{:}_err_corr_xy'.format(season)][0] = data_results['err_corr_ref_other3']
            dataset['{:}_err_cov_xy'.format(season)][0] = data_results['err_cov_ref_other3']
